...
import { Check, X, Clock, Search, MessageSquare, ChevronLeft, ChevronRight, Archive } from "lucide-react";
...
/**
 * Le richieste di iscrizione ai corsi: esattamente quello che la pagina faceva
 * prima, spostato dentro la sua scheda senza cambiarne il funzionamento.
 */
const TabRichiesteCorsi: React.FC<{ puo_gestire_sportivo: boolean }> = ({ puo_gestire_sportivo }) => {
...
export default TabRichiesteCorsi;
