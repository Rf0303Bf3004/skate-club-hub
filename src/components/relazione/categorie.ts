export const CATEGORIE_BLOCCO = [
  { value: "apertura", label: "Apertura", color: "bg-blue-100 text-blue-800 border-blue-200" },
  ...
  { value: "conclusioni", label: "Conclusioni", color: "bg-indigo-100 text-indigo-800 border-indigo-200" },
...
export function cat_blocco(v: string) {
  return CATEGORIE_BLOCCO.find((c) => c.value === v) ?? CATEGORIE_BLOCCO[CATEGORIE_BLOCCO.length - 1];
}
