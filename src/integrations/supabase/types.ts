...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      atleti: {
        Row: {
          ...
          agonista: boolean
          anonimizzato_da: string | null
          anonimizzato_il: string | null
          anonimizzato_motivo: string | null
      ...
      cancellazioni_dati: {
        Row: {
          atleta_id: string | null
          club_id: string
          conservazione_fino: string | null
          dettaglio: Json
          documenti_conservati: number
        ...
        Relationships: [
          {
            foreignKeyName: "cancellazioni_dati_club_id_fkey"
            columns: ["club_id"]
            isOneToOne: false
            referencedRelation: "clubs"
            referencedColumns: ["id"]
      ...
      domande_iscrizione: {
        ...
        Relationships: [
          {
            foreignKeyName: "domande_iscrizione_club_fk"
            columns: ["club_id"]
            isOneToOne: false
            referencedRelation: "clubs"
            referencedColumns: ["id"]
      ...
      fatture: {
        Row: {
          ...
          iva_numero_emittente: string | null
      ...
      stagioni: {
        Row: {
          ...
          iscrizioni_aperte_il: string | null
          iscrizioni_chiuse_il: string | null
    ...
    Views: {
      ...
      atleti_famiglia: {
        Row: {
          ...
          created_at: string | null
          data_nascita: string | null
          deroga_anagrafica: boolean | null
          deroga_anagrafica_da: string | null
          deroga_anagrafica_il: string | null
          deroga_anagrafica_motivo: string | null
          disco_in_preparazione: string | null
          ...
          e_aiuto_monitrice: boolean | null
          e_monitrice: boolean | null
          fatture_intestate_a: string | null
          foto_path: string | null
          foto_url: string | null
          genitore1_cantone: string | null
          genitore1_cap: string | null
        ...
        Insert: {
          ...
          foto_path?: string | null
          foto_url?: string | null
          genitore1_cantone?: never
          genitore1_cap?: never
          genitore1_citta?: never
          genitore1_cognome?: string | null
          genitore1_email?: never
          genitore1_indirizzo?: never
          genitore1_nome?: string | null
          genitore1_paese_iso?: never
          genitore1_provincia?: never
          genitore1_regione?: never
          genitore1_telefono?: never
          genitore2_cantone?: never
          genitore2_cap?: never
          genitore2_citta?: never
          genitore2_cognome?: string | null
          genitore2_email?: never
          genitore2_indirizzo?: never
          genitore2_nome?: string | null
          genitore2_paese_iso?: never
          genitore2_provincia?: never
          genitore2_regione?: never
          genitore2_telefono?: never
          genitori_separati?: boolean | null
          id?: string | null
          importato_da_excel?: boolean | null
          indirizzo?: string | null
    ...
    Functions: {
      ...
      aliquote_iva_disponibili: {
        Args: { p_paese_iso?: string }
        Returns: {
          aliquota: number
          codice: string
          descrizione: string
      ...
      apri_campagna_iscrizioni: {
        Args: { p_club: string; p_scadenza?: string; p_stagione: string }
        Returns: {
          gia_presenti: number
          invitati: number
        }[]
      ...
      chiudi_campagna_iscrizioni: {
        Args: { p_club: string; p_stagione: string }
        Returns: number
      }
      ...
      genera_fatture_periodo_interna: {
        Args: { p_anno: number; p_club: string; p_mese: number }
        Returns: {
          atleta: string
          creata: boolean
      ...
      mobile_genitore: { Args: never; Returns: string }
      ...
      revoca_codice_secondo_genitore: {
        Args: { p_atleta: string }
        Returns: undefined
      }
      ...
      rifiuta_domanda_iscrizione: {
        Args: { p_domanda: string; p_note?: string }
        Returns: undefined
      }
      rifiuta_rinnovo: {
        Args: {
      ...
      setup_iva_club: {
        ...
        Returns: {
          aliquota: number
          aliquote_possibili: Json
          id: string
          livello: string
          nome: string
          nota_esenzione: string
          numero_iva: string
          paese_iso: string
          prezzi_ivati: boolean
          soggetto_iva: boolean
