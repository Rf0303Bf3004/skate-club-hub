ALTER TABLE public.clubs
  ADD COLUMN IF NOT EXISTS reminder_planning_atleti_attivo boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS reminder_planning_istruttori_attivo boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS reminder_planning_orario_invio integer NOT NULL DEFAULT 7,
  ADD COLUMN IF NOT EXISTS reminder_planning_anticipo_giorni integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS reminder_planning_last_run_date date;
      ...
      LOOP
        ...
        VALUES
          (v_club.id,
           ...
           'reminder', 'planning_giornaliero', 'planning_giornaliero', 'sent',
...
SELECT cron.schedule(
  'genera_planning_giornaliero',
  '10 * * * *',
  $$SELECT public.genera_planning_giornaliero();$$
);